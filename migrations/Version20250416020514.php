 ...
 */
final class Version20250416020514 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE livraison CHANGE id_livraison id_livraison INT AUTO_INCREMENT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE livraison ADD CONSTRAINT FK_A60C9F1FFE98B76E FOREIGN KEY (zoneId) REFERENCES zone (idZone) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE zone DROP id_livraison
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE livraison DROP FOREIGN KEY FK_A60C9F1FFE98B76E
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE livraison CHANGE id_livraison id_livraison INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE zone ADD id_livraison INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
