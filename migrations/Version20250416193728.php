 ...
 */
final class Version20250416193728 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE article DROP FOREIGN KEY FK_23A0E66C9486A13
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX fk_categorie ON article
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_23A0E66C9486A13 ON article (id_categorie)
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX fk_user1 ON article
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_23A0E66DE12AB56 ON article (created_by)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE article ADD CONSTRAINT FK_23A0E66DE12AB56 FOREIGN KEY (created_by) REFERENCES user (idUser) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE article ADD CONSTRAINT FK_23A0E66C9486A13 FOREIGN KEY (id_categorie) REFERENCES categorie (id_categorie) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE articlecommande DROP FOREIGN KEY fk_commandeeeee
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE articlecommande DROP FOREIGN KEY fk_articleee
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE articlecommande DROP FOREIGN KEY fk_commandeeeee
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE articlecommande CHANGE id_article_commande id_article_commande INT NOT NULL, CHANGE idArticle idArticle INT DEFAULT NULL, CHANGE idCommande idCommande INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE articlecommande ADD CONSTRAINT fk_commandeeeee FOREIGN KEY (idCommande) REFERENCES commande (id_commande) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE articlecommande ADD CONSTRAINT fk_articleee FOREIGN KEY (idArticle) REFERENCES article (id_article) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE facture CHANGE userId userId INT DEFAULT NULL, CHANGE commandeId commandeId INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE livraison DROP FOREIGN KEY Fk8zone
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE livraison DROP FOREIGN KEY livraison_ibfk_1
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX Fk8zone ON livraison
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE livraison DROP FOREIGN KEY fk_facture
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE livraison CHANGE created_by created_by INT DEFAULT NULL, CHANGE commandeId commandeId INT DEFAULT NULL, CHANGE created_at created_at DATE NOT NULL, CHANGE factureId factureId INT DEFAULT NULL, CHANGE zoneId zone_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX id_livreur ON livraison
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE livraison ADD CONSTRAINT livraison_ibfk_1 FOREIGN KEY (id_livreur) REFERENCES user (idUser) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE trajet MODIFY idTrajet INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE trajet ADD id_trajet INT NOT NULL, DROP idTrajet, CHANGE idZone idZone INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user CHANGE type_vehicule type_vehicule VARCHAR(255) NOT NULL, CHANGE url_image url_image VARCHAR(500) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE zone CHANGE id_user id_user INT DEFAULT NULL, CHANGE latitude_centre latitude_centre DOUBLE PRECISION NOT NULL, CHANGE longitude_centre longitude_centre DOUBLE PRECISION NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX idx_23a0e66c9486a13 ON article
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX fk_categorie ON article (id_categorie)
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX idx_23a0e66de12ab56 ON article
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX fk_user1 ON article (created_by)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE article ADD CONSTRAINT FK_23A0E66C9486A13 FOREIGN KEY (id_categorie) REFERENCES categorie (id_categorie) ON DELETE CASCADE
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE articlecommande CHANGE id_article_commande id_article_commande INT AUTO_INCREMENT NOT NULL, CHANGE idArticle idArticle INT NOT NULL, CHANGE idCommande idCommande INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE articlecommande ADD CONSTRAINT fk_commandeeeee FOREIGN KEY (idCommande) REFERENCES commande (id_commande) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE categorie CHANGE id_categorie id_categorie INT AUTO_INCREMENT NOT NULL, CHANGE created_by created_by INT NOT NULL, CHANGE url_image url_image MEDIUMTEXT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE categorie ADD CONSTRAINT fk_userr FOREIGN KEY (created_by) REFERENCES user (idUser) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE facture CHANGE userId userId INT NOT NULL, CHANGE commandeId commandeId INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE facture ADD CONSTRAINT fk_user FOREIGN KEY (userId) REFERENCES user (idUser) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE livraison CHANGE created_by created_by INT NOT NULL, CHANGE created_at created_at DATE DEFAULT 'CURRENT_TIMESTAMP' NOT NULL, CHANGE commandeId commandeId INT NOT NULL, CHANGE factureId factureId INT NOT NULL, CHANGE zone_id zoneId INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE livraison ADD CONSTRAINT fk_facture FOREIGN KEY (factureId) REFERENCES facture (idFacture) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE livraison ADD CONSTRAINT Fk8zone FOREIGN KEY (zoneId) REFERENCES zone (idZone) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE livraison ADD CONSTRAINT fk_userrrr FOREIGN KEY (created_by) REFERENCES user (idUser) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX Fk8zone ON livraison (zoneId)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX id_livreur ON livraison (id_livreur)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE trajet ADD idTrajet INT AUTO_INCREMENT NOT NULL, DROP id_trajet, CHANGE idZone idZone INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE trajet ADD CONSTRAINT fk_zoneeeee FOREIGN KEY (idZone) REFERENCES zone (idZone) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE trajet ADD PRIMARY KEY (idTrajet)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user CHANGE type_vehicule type_vehicule VARCHAR(255) DEFAULT NULL, CHANGE url_image url_image VARCHAR(500) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE zone CHANGE id_user id_user INT NOT NULL, CHANGE latitude_centre latitude_centre NUMERIC(10, 0) NOT NULL, CHANGE longitude_centre longitude_centre NUMERIC(10, 0) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE zone ADD CONSTRAINT fkLivraison FOREIGN KEY (id_livraison) REFERENCES livraison (idLivraison) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
